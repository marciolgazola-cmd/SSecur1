                    ...
                    rx.vstack(
                        rx.foreach(
                            ...
                            lambda c: rx.grid(
                                ...
                                client_table_cell(
                                    rx.cond(
                                        State.editing_client_id == c["id"].to_string(),
                                        rx.input(
                                            value=State.new_client_name,
                                            on_change=State.set_new_client_name,
                                            bg="var(--input-bg)",
                                    ...
                                    rx.cond(
                                        ...
                                        rx.vstack(
                                            rx.select(
                                                ...
                                                value=State.selected_new_client_parent_option,
                                                on_change=State.set_new_client_parent_option,
                                                placeholder="Sem grupo principal",
                                                bg="var(--input-bg)",
                                                color="var(--text-primary)",
                                                width="100%",
                                            ),
                ...
                rx.grid(
                    ...
                    rx.cond(
                        ...
                        field_block(
                            ...
                            "Usuarios SmartLab nascem no workspace default e acessam apenas os clientes autorizados.",
                        ),
                    ),
                    field_block(
                        "Profissao",
                    ...
                    rx.vstack(
                        rx.foreach(
                            ...
                            lambda u: rx.grid(
                                user_table_cell(
                                    rx.cond(
                                        State.editing_user_id == u["id"].to_string(),
                                        rx.vstack(
                                            rx.input(
                                                value=State.new_user_name,
                                                on_change=State.set_new_user_name,
                                    ...
                                    rx.cond(
                                        ...
                                        rx.vstack(
                                            ...
                                            rx.text(
                                                rx.cond(
                                                    u["role"] != "sem_acesso",
                                                    f'Acesso atual: {u["role"]}',
                                                    "Acesso atual: sem_acesso",
                                                ),
                                                color="var(--text-muted)",
                                                font_size="0.78rem",
                                            ),
                                ...
                                user_table_cell(
                                    rx.cond(
                                        ...
                                        rx.vstack(
                                            ...
                                            rx.text(
                                                rx.cond(
                                                    State.new_user_scope == "smartlab",
                                                    f"Clientes autorizados: {State.selected_assigned_clients_summary}",
                                                    rx.cond(
                                                        State.selected_reporting_user_option != "",
                                                        f"Reporta para: {State.selected_reporting_user_option}",
                                                        "Reporta para: -",
                                                    ),
                                                ),
                                                color="var(--text-muted)",
