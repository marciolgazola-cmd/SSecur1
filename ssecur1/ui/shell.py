                    ...
                    rx.box(
                        rx.vstack(
                            ...
                            rx.box(
                                rx.vstack(
                                    rx.hstack(
                                        rx.heading("Histórico da Conversa", color="var(--text-primary)", size="4"),
                                        rx.spacer(),
                                        rx.badge(f"{State.ai_history_data.length()} item(ns)", color_scheme="orange"),
                                        width="100%",
                                        align="center",
                                    ),
                                    rx.cond(
                                        State.ai_history_data.length() > 0,
                                        rx.vstack(
                                            rx.foreach(
                                                State.ai_history_data,
                                                lambda item: rx.box(
                                                    rx.vstack(
                                                        rx.hstack(
                                                            rx.text(item["asked_at"], color="var(--text-muted)", font_size="0.76rem"),
                                                            rx.spacer(),
                                                            rx.badge(item["model"], color_scheme="purple"),
                                                        ...
                                                        rx.text(item["answer"], color="var(--text-secondary)", white_space="pre-wrap", font_size="0.82rem"),
                                                        align="start",
                                                        spacing="1",
                                                        width="100%",
                                                    ),
                                        ...
                                        rx.text(
                                            "Nenhuma conversa persistida para este contexto ainda.",
                                            color="var(--text-muted)",
                                            font_size="0.84rem",
                                        ),
                                    ),
